 ...
 *
 * One message at a time, with at most one action — "Undo" after a Load, "Reload"
 * after an update, "Report" after a `fatal`. Showing a second toast replaces the
 * first: two stacked notices about a document nobody asked to be notified about is
 * noise, and the caller always has the more important thing to say last.
 *
