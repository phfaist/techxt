...
#[test]
fn examples_10_and_15_math_renders_as_unicode() {
    // PLAN.md §15 #10 and #15: a formula in running text becomes unicode math, and
    // display math becomes a four-space indented block of its own.
